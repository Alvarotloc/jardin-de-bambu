...
const Formulario = (): JSX.Element => {
  ...
  return (
    <div className="contenedor-formulario">
      ...
      <div className={error ? "error-form error" : "error-form"}>
        Los campos Email, Mensaje y Terminos y Condiciones son obligatorios
      </div>
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="Ingrese su número de teléfono con prefijo ej(+34)"
            id="movil"
          />
        </div>
        <div>
        ...
        <div>
          ...
          <textarea
            ...
            value={mensajeProv}
            onChange={(e) => setMensajeProv(e.target.value)}
          ></textarea>
        </div>
        <p>Condiciones*</p>
